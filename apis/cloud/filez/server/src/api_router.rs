...
pub fn build_api_router() -> OpenApiRouter<ServerState> {
    OpenApiRouter::with_openapi(FilezApiDoc::openapi())
        ...
        .routes(routes!(
            http_api::user_groups::join_requests::request::request_to_join_user_group
        ))
        .routes(routes!(
            http_api::user_groups::join_requests::approve::approve_join_request
        ))
        .routes(routes!(
        ...
        .routes(routes!(
            http_api::user_groups::join_requests::list::list_group_join_requests
        ))
        .routes(routes!(
            http_api::user_groups::join_requests::list::list_my_join_requests
        ))
        .routes(routes!(
            http_api::user_groups::invitations::list::list_group_invitations
        ))
        .routes(routes!(
            http_api::user_groups::invitations::list::list_my_invitations
        ))
        // ACCESS POLICIES
        .routes(routes!(
