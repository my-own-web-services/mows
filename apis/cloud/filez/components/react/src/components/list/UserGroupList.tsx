...
export default class UserGroupList extends PureComponent<UserGroupListProps, UserGroupListState> {
    ...
    createUserGroupClick = async () => {
        ...
        await this.context.filezClient.create_user_group(this.state.createGroup);
        ...
        return (
            <div className="Filez UserGroupList" style={{ ...this.props.style }}>
                <ResourceList
                    ...
                    getResourcesList={this.context.filezClient.list_user_groups}
                ...
                <Modal open={this.state.createModalOpen} onClose={this.closeCreateModal}>
                    ...
                    <Modal.Footer>
                        <Button onClick={this.createUserGroupClick} appearance="primary">
                            Create
                        </Button>
                ...
                <Modal open={this.state.deleteModalOpen} onClose={this.closeDeleteModal}>
                    <Modal.Header>
                        <Modal.Title>
                            Delete {items?.length} user groups? This cannot be undone.
                        </Modal.Title>
                    </Modal.Header>
                    <Modal.Footer>
                ...
                <Modal open={this.state.editModalOpen} onClose={this.closeEditModal}>
                    ...
                    <Modal.Body>
                        <UserGroup onChange={this.editChange} userGroup={this.state.editGroup} />
                    </Modal.Body>
                    <Modal.Footer>
                        <Button onClick={this.saveEditClick} appearance="primary">
                            Save
                        </Button>
