...
const defaultColumns: Column<ReducedFilezUser>[] = [
    {
        ...
        visible: true,
        render: (item) => {
            return <span style={{ height: "100%" }}>{item.name ?? item._id}</span>;
        }
    },
    {
        field: "role",
        ...
        return (
            <div className="Filez UserList" style={{ ...this.props.style }}>
                <ResourceList
                    ...
                    getResourcesList={this.context.filezClient.list_users}
                ...
                <Modal open={this.state.createModalOpen} onClose={this.closeCreateModal}>
                    ...
                    <Modal.Footer>
                        <Button onClick={this.createUserClick} appearance="primary">
                            Create
                        </Button>
                ...
                <Modal open={this.state.deleteModalOpen} onClose={this.closeDeleteModal}>
                    ...
                    <Modal.Footer>
                        <Button onClick={this.deleteUsersClick} appearance="primary" color="red">
                            Delete
                        </Button>
