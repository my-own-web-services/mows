...
> {
    ...
    deletePermissionClick = async () => {
        ...
        await this.context.filezClient.delete_permissions(selectedPermissions.map((p) => p._id));
        ...
        return (
            <div className="Filez PermissionList" style={{ ...this.props.style }}>
                <ResourceList
                    ...
                    getResourcesList={this.context.filezClient.list_permissions}
                ...
                <Modal open={this.state.createModalOpen} onClose={this.closeCreateModal}>
                    ...
                    <Modal.Body>
                        <Permission disableSaveButton onChange={this.onCreatePermissionChange} />
                    </Modal.Body>

                    <Modal.Footer>
                        <Button onClick={this.createPermissionClick} appearance="primary">
                            Create
                        </Button>
                ...
                <Modal open={this.state.deleteModalOpen} onClose={this.closeDeleteModal}>
                    <Modal.Header>
                        <Modal.Title>
                            Delete {items?.length} permissions? This cannot be undone.
                        </Modal.Title>
                    </Modal.Header>
                    <Modal.Footer>
                        <Button
