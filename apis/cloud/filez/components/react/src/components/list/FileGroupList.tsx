...
export default class FileGroupList extends PureComponent<FileGroupListProps, FileGroupListState> {
    ...
    deleteClick = async () => {
        ...
        if (!items) return;
        await this.context.filezClient.delete_file_groups(items.map((i) => i._id));
        ...
        return (
            <div className="Filez FileGroupList" style={{ ...this.props.style }}>
                <ResourceList
                    ...
                    getResourcesList={this.context.filezClient.list_file_groups}
                ...
                <Modal open={this.state.createModalOpen} onClose={this.closeCreateModal}>
                    ...
                    <Modal.Body>
                        <FileGroup onChange={this.newFileGroupChange} serverUpdate={false} />
                    </Modal.Body>
