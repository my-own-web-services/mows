...
import { Checkbox, IconButton, Input, InputGroup } from "rsuite";
import { Column } from "./ResourceListTypes";
...
> {
    ...
    componentDidUpdate(prevProps: Readonly<SortingBarProps<ResourceType>>): void {
        if (
                ...
                <Menu id={this.getId()}>
                    ...
                    <Item closeOnClick={false}>
                        <InputGroup>
                            ...
                            >
                                <IconButton style={{ cursor: "pointer" }} as={FaPlus} />
                            </InputGroup.Button>
                        </InputGroup>
                    </Item>
                </Menu>
