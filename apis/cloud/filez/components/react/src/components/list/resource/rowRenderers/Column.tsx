...
import { DraggableTarget } from "../../../dragAndDrop/DraggableTarget";
import {
    BaseResource,
    ListRowProps,
    RowRenderer,
    ...
    render = () => {
        ...
        return (
            ...
            >
                ...
                >
                    <DraggableTarget
                        acceptTypes={this.props.data.dropTargetAcceptsTypes ?? []}
                        id={item._id}
                        type={itemType}
                ...
                {this.props.data.disableContextMenu !== true && (
                    <RowContextMenu
                        ...
                        getSelectedItems={this.props.data.functions.getSelectedItems}
                        getLastSelectedItem={this.props.data.functions.getLastSelectedItem}
                    />
                )}
            </div>
        );
...
const ColumnListRowRenderer = <ResourceType extends BaseResource>(): RowRenderer<ResourceType> => ({
