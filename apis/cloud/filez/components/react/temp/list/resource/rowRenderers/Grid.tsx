                    ...
                    return (
                        ...
                        >
                            <DraggableItem
                                ...
                                getSelectedItems={data.functions.getSelectedItems}
                                type={resourceType}
                            >
                                <DraggableTarget
                                    acceptTypes={data.dropTargetAcceptsTypes ?? []}
                                    id={item._id}
                                    type={resourceType}
                                    canDrop={canDrop}
                                >
                            ...
                            {disableContextMenu !== true && (
                                <RowContextMenu
                                    ...
                                    getSelectedItems={data.functions.getSelectedItems}
                                    getLastSelectedItem={data.functions.getLastSelectedItem}
                                />
                            )}
                        </div>
                    );
...
const GridRowRenderer = <ResourceType extends BaseResource>(): RowRenderer<ResourceType> => ({
            ...
            if (Object.keys(selectedItems).length === 0) {
                ...
                const newIndex = (() => {
                    if (e.key === "ArrowUp") {
                        ...
                        const mb = lastSelectedItemIndex + gridColumnCount;
                        return mb < lastIndex ? mb : 0 + (lastSelectedItemIndex % gridColumnCount);
