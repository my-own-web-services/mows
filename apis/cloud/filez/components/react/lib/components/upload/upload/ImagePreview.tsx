...
import { HoverCard, HoverCardContent, HoverCardTrigger } from "@my-own-web-services/react-components/components/ui/hover-card";
import { Skeleton } from "@my-own-web-services/react-components/components/ui/skeleton";
