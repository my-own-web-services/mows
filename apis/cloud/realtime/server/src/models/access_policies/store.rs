...
#[derive(Debug)]
pub struct RealtimePolicyStore<'a> {
    database: &'a Database,
}

impl<'a> RealtimePolicyStore<'a> {
...
fn action_from_u32(v: u32) -> Option<AccessPolicyAction> {
    match v {
        ...
        160 => Some(AccessPolicyAction::ChannelsPublish),
...
#[async_trait]
impl<'a> PolicyStore for RealtimePolicyStore<'a> {
