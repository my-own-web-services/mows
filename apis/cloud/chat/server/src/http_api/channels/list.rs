...
use crate::{
    ...
    models::{
        access_policies::{
            ...
            store::ChatPolicyStore, AccessPolicyAction, AccessPolicyResourceType,
        },
...
pub async fn list_channels(
    ...
    let store = ChatPolicyStore::new(&state.database);
