...
kubectl apply -f /operators/pektin-dns-controller/yaml/crd.yaml && helm upgrade --install mows-core-dns-pektin-controller /operators/pektin-dns-controller/charts/pektin-dns-controller/ -n mows-core-dns-pektin --create-namespace && kubectl apply -f /operators/pektin-dns-controller/yaml/example.yaml
