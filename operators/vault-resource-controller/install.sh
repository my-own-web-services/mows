...
kubectl patch crd/vaultresources.vault.k8s.mows.cloud -p '{"metadata":{"finalizers":[]}}' --type=merge ; kubectl delete vaultresources.vault.k8s.mows.cloud --all ; kubectl delete crd vaultresources.vault.k8s.mows.cloud ; helm uninstall mows-core-secrets-vrc -n mows-core-secrets-vrc ; kubectl delete ns mows-core-secrets-vrc
