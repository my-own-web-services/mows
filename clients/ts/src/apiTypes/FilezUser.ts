...
export interface FilezUser { _id: string, ir_user_id: string | null, name: string | null, email: string | null, role: UserRole, visibility: UserVisibility, friends: Array<string>, pending_friend_requests: Array<string>, pending_friend_confirmations: Array<string>, status: UserStatus, app_data: Record<string, any>, limits: Record<string, UsageLimits>, user_group_ids: Array<string>, }