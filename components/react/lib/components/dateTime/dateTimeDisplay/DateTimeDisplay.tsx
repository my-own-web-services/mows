...
type DateTimeDisplayState = Record<string, never>;

export default class DateTimeDisplay extends PureComponent<DateTimeDisplayProps, DateTimeDisplayState> {
    static contextType = MowsContext;
    declare context: React.ContextType<typeof MowsContext>;

    constructor(props: DateTimeDisplayProps) {
        super(props);
        this.state = {};
    }
    ...
    render = () => {
        ...
        return (
            <div style={{ ...this.props.style }} className={cn(`DateTimeDisplay`, this.props.className)}>
