        ...
        return (
            ...
            >
                            ...
                            ? ticks.map((t) => {
                                  ...
                                  return (
                                      ...
                                      >
                                          ...
                                          <span
                                              className={`mt-auto h-1.5 w-px bg-border`}
                                          />
                                      </div>
                                  );
                              })
                ...
                <div
                    ...
                    className={`relative h-6 cursor-pointer select-none rounded-md border border-border bg-muted/40`}
                >
                    {/* mini event markers — give the user a hint of where the
                         action is even when fully zoomed out elsewhere */}
                    {scrubberWidth > 0
                        ? events.map((event) => renderScrubberMiniEvent(event))
                        : null}
                    ...
                    <div
                        ...
                        className={`absolute inset-y-0 flex cursor-grab items-stretch rounded-md border border-primary/50 bg-primary/15 backdrop-blur-sm transition-colors hover:bg-primary/20 active:cursor-grabbing`}
                    ...
                    >
                        <div
                            ...
                            className={`group flex w-2 cursor-ew-resize items-center justify-center rounded-l-md bg-primary/60 hover:bg-primary`}
                        >
                            <span
                                aria-hidden
                                className={`h-3 w-0.5 rounded-full bg-primary-foreground/70`}
                            />
                        </div>
                        ...
                        <div
                            ...
                            className={`group flex w-2 cursor-ew-resize items-center justify-center rounded-r-md bg-primary/60 hover:bg-primary`}
                        >
                            <span
                                aria-hidden
                                className={`h-3 w-0.5 rounded-full bg-primary-foreground/70`}
