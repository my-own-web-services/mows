...
export interface ColumnListRowHandlerProps<ResourceType> {
...
export default class ColumnListRowHandler<ResourceType extends BaseResource>
    implements ListRowHandler<ResourceType>
{
    ...
    rowHeightPixels = 24;
    props: ColumnListRowHandlerProps<ResourceType>;
    columns: Column<ResourceType>[];

    constructor(props: ColumnListRowHandlerProps<ResourceType>) {
        this.props = props;
    ...
    checkColumns = (columns: Column<ResourceType>[]) => {
    ...
    isItemLoaded = (items: (ResourceType | undefined)[], index: number): boolean => {
