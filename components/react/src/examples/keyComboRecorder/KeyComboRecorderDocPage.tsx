...
const USAGE_SNIPPET = `import { KeyComboRecorder } from "mows-components-react";
...
const useDocStrings = () => {
    ...
    if (!ctx) throw new Error(`<KeyComboRecorderDocPage> must be rendered inside <MowsProvider>`);
    return ctx.t.example.examples.keyComboRecorder;
};
