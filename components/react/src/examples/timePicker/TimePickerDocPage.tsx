...
const USAGE_SNIPPET = `import { TimePicker } from "mows-components-react";
...
const useDocStrings = () => {
    ...
    if (!ctx) throw new Error(`<TimePickerDocPage> must be rendered inside <MowsProvider>`);
    return ctx.t.example.examples.timePicker;
};
