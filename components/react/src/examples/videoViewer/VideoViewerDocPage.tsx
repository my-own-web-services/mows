...
const PACKAGE_INSTALL = `add @my-own-web-services/react-components shaka-player`;

const USAGE_SNIPPET = `import VideoViewer from "@my-own-web-services/react-components/components/files/fileViewer/formats/videoViewer/VideoViewer";
