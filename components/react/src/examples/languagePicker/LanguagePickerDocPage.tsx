...
const USAGE_SNIPPET = `import { LanguagePicker } from "@my-own-web-services/react-components";
...
const useDocStrings = () => {
    ...
    if (!mowsContext) throw new Error(`<LanguagePickerDocPage> must be rendered inside <MowsProvider>`);
    return mowsContext.t.example.examples.languagePicker;
};
