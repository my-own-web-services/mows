...
const USAGE_SNIPPET = `import { FileViewer } from "mows-components-react";
...
const useDocStrings = () => {
    ...
    if (!ctx) throw new Error(`<FileViewerDocPage> must be rendered inside <MowsProvider>`);
    return ctx.t.example.examples.fileViewer;
};
