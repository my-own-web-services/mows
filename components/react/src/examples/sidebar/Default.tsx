...
const Example = () => {
    useExampleState({ collapsible: `icon`, defaultOpen: true });
                ...
                <Sidebar collapsible={`icon`} className={`absolute`}>
                    ...
                    <SidebarContent>
                        <SidebarGroup>
                            ...
                            <SidebarGroupContent>
                                <SidebarMenu>
                                    {[`Dashboard`, `Files`, `Console`].map((label) => (
                    ...
                    <SidebarFooter>
                        <span className={`px-2 text-xs text-muted-foreground`}>v0.0.1</span>
                    </SidebarFooter>
                </Sidebar>
            </SidebarProvider>
        </div>
...
const module: ExampleModule = {
    strings: (t) => t.examples.sidebar.default,
    Example
};
